...
// Layar latihan utama √¢‚Ç¨î soal di WebView, bot overlay di atas
...
// √¢î‚Ç¨√¢î‚Ç¨ Bot audio helpers √¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨
...
export default function PracticeScreen({ navigation }) {
  ...
  // √¢î‚Ç¨√¢î‚Ç¨ Selection Rule (FASE 8.3b) √¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨
  ...
  // √¢î‚Ç¨√¢î‚Ç¨ Load soal + welcome audio √¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨
  useEffect(() => {
    loadExercises();
  }, [currentLevel]);

  // ó Cleanup saat unmount: hentikan timer & audio yang masih tertunda ó
  useEffect(() => {
  ...
  // √¢î‚Ç¨√¢î‚Ç¨ Idle detection: 30s audio, 60s audio, 120s sleeping √¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨
  ...
  // √¢î‚Ç¨√¢î‚Ç¨ Pesan dari WebView (jawaban siswa) √¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨
  ...
  // √¢î‚Ç¨√¢î‚Ç¨ handleCorrect √¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨
  async function handleCorrect(timeMs) {
    ...
    if (isLastQuestion) {
      ...
      // Speed comment (acak, dicek independen per kategori waktu agar tidak tumpang tindih)
      const r = Math.random();
    ...
    nextTimerRef.current = setTimeout(async () => {
      ...
      if (currentIndex < exercises.length - 1) {
        ...
        // Simpan sesi ke DB sebelum navigasi
        ...
        // Demo mode: skip saveSession dan level-up ó tidak hit DB
  ...
  // √¢î‚Ç¨√¢î‚Ç¨ handleWrong √¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨
  async function handleWrong() {
    ...
    // sfx_wrong selesai ó satu sfxPlayer, jadi dijalankan berurutan, bukan
  ...
  // √¢î‚Ç¨√¢î‚Ç¨ playBotAudio √¢‚Ç¨î bot reaction (no exercise viseme) √¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨
  async function playBotAudio(id, hype = false) {
    try {
      ...
      // Sprint H.7 ó fetch viseme dari R2 via /api/bot-viseme/:id
      ...
      // Aktifkan lip-sync di BotCharacter ó hype=true ? speaking_hype (ekspresi semangat)
  ...
  // √¢î‚Ç¨√¢î‚Ç¨ playSound √¢‚Ç¨î exercise TTS dengan viseme lip-sync √¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨
  ...
  // √¢î‚Ç¨√¢î‚Ç¨ Inject script WebView √¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨√¢î‚Ç¨
  const INJECTED_JS = `
    (function() {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Text style={styles.back}>{'√¢‚Ä†¬ê'}</Text>
        </TouchableOpacity>
